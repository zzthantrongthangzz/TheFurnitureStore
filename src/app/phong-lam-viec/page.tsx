// src/app/phong-lam-viec/page.tsx
"use client";
...
// ĐỔI LIST DANH MỤC THÀNH CÁC TÙY CHỌN CẤP 3 CỦA PHÒNG LÀM VIỆC
...
export default function WorkspacePage() {
  // LỌC DỮ LIỆU: Chỉ lấy các sản phẩm thuộc danh mục "phong-lam-viec"
  const workspaceProducts = mockProducts.filter(
    (p) => p.category === "phong-lam-viec",
  );
  ...
  const {
    ...
    paginatedProducts,
    totalCount,
  } = useProductFilter(workspaceProducts);
              ...
              {filters.categories.length > 0 && (
                <div className="flex items-center flex-wrap gap-2">
                  ...
                  {filters.categories.map((val) => (
                    ...
                    >
                      {/* Đổi thành WORKSPACE_CATEGORIES */}
                      <span>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <aside className="w-full lg:w-[240px] shrink-0">
            <div className="sticky top-24 space-y-5">
              ...
              {/* ĐỔI THÀNH DANH MỤC PHÒNG LÀM VIỆC */}
              <FilterAccordion
                title="Danh mục"
