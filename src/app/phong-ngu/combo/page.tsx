...
export default function BedroomComboPage() {
  ...
  const {
    ...
    paginatedProducts,
    totalCount,
  } = useProductFilter(comboProducts);

  // Đã bỏ 'category' ra khỏi state vì trang này không cần lọc danh mục nữa
  ...
  return (
    <main className="min-h-screen bg-white text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Breadcrumb điều hướng (UX Tốt cho trang cấp 3) */}
        <nav className="flex text-sm text-gray-500 mb-4 space-x-2">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Combo Phòng Ngủ</span>
        </nav>
        ...
        {/* Tag đang lọc (Đã bỏ tag Categories) */}
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <aside className="w-full lg:w-[240px] shrink-0">
            <div className="sticky top-24 space-y-5">
              ...
              {/* Đã xóa FilterAccordion của Danh mục vì không cần thiết ở cấp 3 */}
