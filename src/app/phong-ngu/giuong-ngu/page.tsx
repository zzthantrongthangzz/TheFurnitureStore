...
export default function BedPage() {
  // LỌC DỮ LIỆU CẤP 3: Giường ngủ
  const bedProducts = mockProducts.filter(
    (p) => p.category === "phong-ngu" && p.subCategory === "giuong-ngu",
  );
    ...
    <main className="min-h-screen bg-white text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex text-sm text-gray-500 mb-4 space-x-2">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Giường Ngủ</span>
        </nav>
