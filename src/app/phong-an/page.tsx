...
export default function DiningRoomPage() {
  // LỌC DỮ LIỆU: Chỉ lấy các sản phẩm thuộc danh mục "phong-an"
  const diningRoomProducts = mockProducts.filter(
    (p) => p.category === "phong-an",
  );
  ...
  const {
    ...
    paginatedProducts,
    totalCount,
  } = useProductFilter(diningRoomProducts);
              ...
              {filters.categories.length > 0 && (
                <div className="flex items-center flex-wrap gap-2">
                  ...
                  {filters.categories.map((val) => (
                    ...
                    >
                      {/* Đổi thành DINING_ROOM_CATEGORIES */}
                      <span>
