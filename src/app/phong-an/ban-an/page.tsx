...
function DiningTablePageContent() {
  // LỌC DỮ LIỆU CẤP 3: Bàn ăn
  const diningTableProducts = mockProducts.filter(
    (p) => p.category === "phong-an" && p.subCategory === "ban-an",
  );
  ...
  const {
    ...
    paginatedProducts,
    totalCount,
  } = useProductFilter(diningTableProducts);
    ...
    <main className="min-h-screen bg-white text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex text-sm text-gray-500 mb-4 space-x-2">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Bàn Ăn</span>
        </nav>
